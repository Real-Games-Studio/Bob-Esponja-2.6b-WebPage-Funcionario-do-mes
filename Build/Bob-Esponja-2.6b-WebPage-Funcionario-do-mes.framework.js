...
var ASM_CONSTS = {
  3474800: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3474861: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3474925: function() {return Module.webglContextAttributes.powerPreference;},  
 3474983: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3475038: function($0) {performance.now = function() { return $0; };},  
 3475086: function($0) {performance.now = function() { return $0; };},  
 3475134: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _IsWebGLfTrackerReady()
      {
  ...
  function _SetWebGLfTrackerSettings(settings)
  	{
      	window.fTracker.setTrackerSettings(UTF8ToString(settings), "1.0.3.717342");
      }
  ...
  function _StartWebGLfTracker(name)
  	{
          if(!window.fTracker){
  ...
  function _StopWebGLfTracker()
  	{
      	window.fTracker.stopTracker();
      }

  var ws = {webSocketInstances:{},nextInstanceId:1,Set:function(socket) {
  		...
  		},_callOnClose:function(onClose, id, code, reason)
  		{
  			...
  			(function(a1, a2, a3) {  dynCall_viii.apply(null, [onClose, a1, a2, a3]); })(id, code, buffer);
  		...
  		},_callOnError:function(errCallback, id, reason)
  		{
  			...
  			(function(a1, a2) {  dynCall_vii.apply(null, [errCallback, a1, a2]); })(id, buffer);
  ...
  function _WS_Create(url, protocol, onOpen, onText, onBinary, onError, onClose, allocator)
  	{
  		...
  		socket.socketImpl.onopen = function(e) {
  			...
  			(function(a1) {  dynCall_vi.apply(null, [onOpen, a1]); })(id);
  		};
  		...
  		socket.socketImpl.onmessage = function (e)
  		{
  			...
  			if (e.data instanceof ArrayBuffer)
  			{
  				...
  				const array = (function(a1, a2) { return dynCall_iii.apply(null, [allocator, a1, a2]); })(id, byteArray.length);
  				...
  				(function(a1, a2, a3, a4) {  dynCall_viiii.apply(null, [onBinary, a1, a2, a3, a4]); })(id, array, originalLength, byteArray.length);
  			}
  			else // Text
  			{
  				...
  				const array = (function(a1, a2) { return dynCall_iii.apply(null, [allocator, a1, a2]); })(id, length);
  				
  				const numArr = HEAPU8.subarray(array, array + 4);
  				const originalLength = (numArr[0] << 24) | (numArr[1] << 16) | (numArr[2] << 8) | (numArr[3]);
  				const ret = encoder.encodeInto(e.data, HEAPU8.subarray(array));
  				
  				(function(a1, a2, a3, a4) {  dynCall_viiii.apply(null, [onText, a1, a2, a3, a4]); })(id, array, originalLength, ret.written);
  			}
  		};
...
var asmLibraryArg = {
  ...
  "IsWebGLfTrackerReady": _IsWebGLfTrackerReady,
  ...
  "SetWebGLfTrackerSettings": _SetWebGLfTrackerSettings,
  "ShowConfirmUrl": _ShowConfirmUrl,
  "ShowWebGLScreenshot": _ShowWebGLScreenshot,
  "StartWebGLfTracker": _StartWebGLfTracker,
  "StopWebGLfTracker": _StopWebGLfTracker,
  "WS_Close": _WS_Close,
